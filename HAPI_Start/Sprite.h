...
public:
	...
	void Blit(BYTE *screen, Rectangle &clippedRect, int screenWidth, int posX, int posY); // no alpha
	void BlitAlpha(BYTE *screen, Rectangle &clippedRect, int screenWidth, int posX, int posY); // alpha
	void Animate();
